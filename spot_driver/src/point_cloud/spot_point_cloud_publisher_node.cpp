...
SpotPointCloudPublisherNode::SpotPointCloudPublisherNode(
    std::unique_ptr<SpotApi> spot_api, std::unique_ptr<SpotPointCloudPublisher::MiddlewareHandle> mw_handle,
...
void SpotPointCloudPublisherNode::initialize(std::unique_ptr<SpotApi> spot_api,
  ...
  internal_ = std::make_unique<SpotPointCloudPublisher>(spot_api_->point_cloud_client_interface(), std::move(mw_handle),
                                                        std::move(parameters), std::move(logger),
                                                        std::move(tf_broadcaster), std::move(timer));
}
