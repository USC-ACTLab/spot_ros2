...
tl::expected<sensor_msgs::msg::PointCloud2, std::string> toPointCloud2Msg(const ::bosdyn::api::PointCloud& point_cloud,
                                                                          const std::string& robot_name,
                                                                          const google::protobuf::Duration& clock_skew) {
...
DefaultPointCloudClient::getPointCloud(::bosdyn::api::GetPointCloudRequest request) {
